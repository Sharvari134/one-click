...
resource "aws_subnet" "public_subnets" {
  ...
  availability_zone       = element(["ap-northeast-3a", "ap-northeast-3b"], count.index)
...
# Security Group for Cassandra Servers
...
resource "aws_vpc_peering_connection" "vpc_peering" {
  vpc_id      = aws_vpc.main.id
  peer_vpc_id = "vpc-0e1b49ec15c5f5e4e" # Replace with your Default VPC ID
...
resource "aws_route" "default_to_custom" {
  route_table_id         = "rtb-0e1b8540dca1f7480" # Replace with Default VPC Route Table ID
